        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <Card className="border-0 shadow-md">
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <>
                    <p className="text-3xl font-bold text-blue-600">{dashboardStats.waitingApproval}</p>
          ...
          <Tabs defaultValue="approvals" className="w-full">
            <TabsList className="w-full justify-start border-b rounded-none">
              ...
              <TabsTrigger value="legal" className="data-[state=active]:text-navy flex items-center gap-2">
            ...
            <TabsContent value="supplier-ratings" className="mt-6">
              <SupplierRatingConfiguration supplierId={null} onClose={() => {}} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
